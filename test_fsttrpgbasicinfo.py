...
import application.basicinfo.utilities
from application.basicinfo.databases import DBManager
from application.basicinfo.models import Names, BasicInfo as ModelBasicInfo
...
class TestUtilities(unittest.TestCase):
    ...
    def test_upload(self):
        response = application.basicinfo.utilities.upload_character_to_aws(name='test', role='test', gender='male',
                                                                           country='us',
                                                                           birthday='11.1', age=18, alias="test")
        self.assertEqual(response['response'], 'success')

    def test_get_aws_names(self):
        response = application.basicinfo.utilities.get_aws_names_group('test')
